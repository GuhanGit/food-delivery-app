...
public class PaymentServiceImpl implements PaymentService {
   ...
   /* @Override
    public Payment getPaymentByOrderId(String orderId) {
        return this.paymentRepository.findByClaimsId(orderId);
    }*/
    ...
    @Override
    public void updateOrderStatusAfterPayment(String claimId, OrderStatusUpdateMessage orderStatusUpdateMessage) {
    	System.out.println("updateOrderStatusAfterPayment:::"+claimId+":::"+orderStatusUpdateMessage.getOrderStatus());
        String url = "http://localhost:8083/claim/";
        restTemplate.postForLocation(url+claimId, orderStatusUpdateMessage);
    }
